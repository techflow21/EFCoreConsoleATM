...
namespace ConsoleAtmData.Migrations
{
    ...
    [Migration("20230227234422_UpdatedTransModel")]
    partial class UpdatedTransModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCoreATM_Data.Models.TransactionDetail", b =>
                {
                    b.HasOne("EFCoreATM_Data.Models.Admin", "Admin")
                        .WithMany("Transactions")
                        .HasForeignKey("AdminId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EFCoreATM_Data.Models.AtmMachine", "AtmMachine")
                        .WithMany("Transactions")
                        .HasForeignKey("AtmMachineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EFCoreATM_Data.Models.Customer", "Customer")
                        .WithMany("Transactions")
